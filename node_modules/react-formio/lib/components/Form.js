...
var _initialiseProps = function _initialiseProps() {
  ...
  this.initializeFormio = function () {
    if (_this2.createPromise) {
      if (_this2.instance.hasOwnProperty('on')) {
        _this2.instance.on('render', _this2.emit('onRender'));
        _this2.instance.on('attach', _this2.emit('onAttach'));
        _this2.instance.on('build', _this2.emit('onBuild'));
      }
      _this2.createPromise.then(function () {
        ...
        _this2.formio.on('cancel', _this2.emit('onCancel'));
