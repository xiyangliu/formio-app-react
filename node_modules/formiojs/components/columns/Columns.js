  ...
  _createClass(ColumnsComponent, [{
    ...
    value: function init() {
      ...
      _lodash.default.each(this.component.columns, function (column, index) {
        ...
        _lodash.default.each(column.components, function (component) {
          component.hideOnChildrenHidden = _this2.component.hideOnChildrenHidden;

          _this2.columns[index].push(_this2.createComponent(component));
        });
      });
